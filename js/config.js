/**
 * إعدادات منظومة جلب العالمية - الإصدار 42.0
 */
const CONFIG = {
  COMPANY_NAME: 'شركة جلب العالمية للتجارة',
  LOGO_PATH: 'assets/logo.png',
  
  // الرابط البرمجي لنشر الويب في Google Apps Script
  APPS_SCRIPT_URL: 'https://script.google.com/macros/s/AKfycbyf2pX-q3M9pLp8iWbU1Hw6w1vT_o9I5gB2tq_V1X4/exec',
